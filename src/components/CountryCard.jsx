...
const CountryCard = ({ country }) => {
  return (
    <div className="light-mode-elements w-[320px] lg:w-[400px] xl:w-[100%] h-[452px] mx-auto rounded-lg shadow-md cursor-pointer transition-all hover:duration-200 hover:scale-110 hover:shadow-2xl">
